...
- 소분/묶음 판매 상품은 총중량만 단독 강조하지 말고 판매 단위를 우선 표기합니다.
- 예: 총 4.1kg와 44개입이 함께 보이면 "44개입 (총 4.1kg) / 개당 약 93.2g"처럼 specs와 주의사항에 반영합니다.
- 원재료·함량·내용량 항목도 구매자가 받는 소분 포장 단위를 먼저 노출합니다.
