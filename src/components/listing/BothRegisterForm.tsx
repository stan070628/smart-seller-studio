        ...
        >
          ...
          >
            ...
            {needCoupang && <div>
              ...
              {/* 쿠팡 세부 설정 (마운트 후 localStorage 값으로 렌더) */}
              {coupangMounted && (
                <>
                  <Divider label="쿠팡 세부 설정" />
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px' }}>
                    <div style={{ flex: '1 1 calc(50% - 6px)', minWidth: '140px' }}>
                      ...
                      <select
                        ...
                        onChange={(e) => setCoupangDefaults((prev) => ({ ...prev, deliveryCompanyCode: e.target.value }))}
                      >
                    ...
                    <div style={{ flex: '1 1 calc(50% - 6px)', minWidth: '140px' }}>
                      ...
                      <input
                        ...
                        onChange={(e) => setCoupangDefaults((prev) => ({ ...prev, outboundShippingTimeDay: Number(e.target.value) }))}
                      />
                    </div>
                    <div style={{ flex: '1 1 calc(50% - 6px)', minWidth: '140px' }}>
                      ...
                      <select
                        ...
                        onChange={(e) => setCoupangDefaults((prev) => ({ ...prev, taxType: e.target.value as CoupangItemDefaults['taxType'] }))}
                      >
                    ...
                    <div style={{ flex: '1 1 calc(50% - 6px)', minWidth: '140px' }}>
                      ...
                      <select
                        ...
                        onChange={(e) => setCoupangDefaults((prev) => ({ ...prev, adultOnly: e.target.value as CoupangItemDefaults['adultOnly'] }))}
                      >
                    ...
                    <div style={{ flex: '1 1 calc(50% - 6px)', minWidth: '140px' }}>
                      ...
                      <select
                        ...
                        onChange={(e) => setCoupangDefaults((prev) => ({ ...prev, overseasPurchased: e.target.value as CoupangItemDefaults['overseasPurchased'] }))}
                      >
                    ...
                    <div style={{ flex: '1 1 calc(50% - 6px)', minWidth: '140px' }}>
                      ...
                      <select
                        ...
                        onChange={(e) => setCoupangDefaults((prev) => ({ ...prev, parallelImported: e.target.value as CoupangItemDefaults['parallelImported'] }))}
                      >
                    ...
                    {coupangDefaults.notices.map((notice, i) => (
                      <div key={i} style={{ display: 'flex', gap: '8px', marginBottom: '8px', alignItems: 'center' }}>
                        <input
                          ...
                          onChange={(e) => setCoupangDefaults((prev) => ({
                            ...prev,
                        ...
                        <button
                          type="button"
                          onClick={() => setCoupangDefaults((prev) => ({
                            ...prev,
