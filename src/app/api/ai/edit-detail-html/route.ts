...
const EDIT_SYSTEM_PROMPT =
  ...
  "이미지 정책 (쿠팡 광고 가이드 준수): 이미지를 새로 만들 수는 없지만, HTML 안에서 이미지 위에 가격·홍보 문구·\"1위\"·\"세일\" 같은 텍스트 오버레이 박스를 추가하지 않습니다. 기존 이미지 src/alt는 그대로 유지하고, 새로운 가짜 뱃지·워터마크·콜라주 마크업을 만들지 않습니다. " +
