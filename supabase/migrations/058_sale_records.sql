...
CREATE TABLE IF NOT EXISTS sale_records (
  ...
  -- user_id nullable (no FK) — custom auth pattern, same as product_costs/cost_entries
  user_id               uuid,
...
-- received_at used as sold_at proxy — legacy combined records (deliberate mapping)
